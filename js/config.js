...
const INSTALL_SQL = [
  ...
  'alter table public.bills add column if not exists type text not null default \'exp\';',
  ...
  'alter table public.bill_templates add column if not exists type text not null default \'exp\';',
  ...
  'drop policy if exists "family_access" on public.bank_payments;',
  'create policy "family_access" on public.bank_payments for all to authenticated using (true) with check (true);',
